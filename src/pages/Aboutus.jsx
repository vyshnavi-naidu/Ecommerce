...
const Aboutus = () => {
  return (
    <div>
      ...
      <div className="bg-fuchsia-100 mt-16 mx-4 md:mx-20 rounded-lg overflow-hidden">
      ...
      <div className="mt-20 px-6 md:px-20 mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
          ...
          <div className="bg-white shadow-md p-6 rounded-lg hover:shadow-xl transition duration-300">
            <h3 className="text-4xl font-bold text-fuchsia-400 mb-2">500+</h3>
            <p className="text-stone-600 font-medium">Products Available</p>
          </div>

          {/* Stat 2 */}
          <div className="bg-white shadow-md p-6 rounded-lg hover:shadow-xl transition duration-300">
            <h3 className="text-4xl font-bold text-fuchsia-400 mb-2">1200+</h3>
            <p className="text-stone-600 font-medium">Orders Completed</p>
          </div>

          {/* Stat 3 */}
          <div className="bg-white shadow-md p-6 rounded-lg hover:shadow-xl transition duration-300">
            <h3 className="text-4xl font-bold text-fuchsia-400 mb-2">900+</h3>
